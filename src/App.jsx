...
// ─── Admin Page ───
const AdminPage = ({ gameState, players, history, onBack, onTogglePaid, onRemovePlayer, onDrawNumbers }) => {
...
export default function App() {
  ...
  if (page === "admin") return <AdminPage gameState={gameState} players={players} history={history} onBack={() => setPage("main")} onTogglePaid={togglePaid} onRemovePlayer={removePlayer} onDrawNumbers={drawNumbers} />;
